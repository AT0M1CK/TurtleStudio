  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="mx-auto w-full max-w-3xl animate-pulse px-5 py-10 sm:px-8 sm:py-14">
        ...
        <div className="mt-6 h-6 w-28 rounded bg-foreground/10" />
        <div className="mt-3 h-10 w-72 rounded bg-foreground/10" />
        <div className="mt-8 h-20 w-full rounded-[6px] bg-foreground/5" />
        <div className="mt-8 h-32 w-full rounded-[6px] bg-foreground/5" />
      </div>
    </div>
  );
}
